...
package com.tomasino.sequence
{
	...
	public class SequenceManager extends EventDispatcher
	{
		...
		{
			if(_debug) trace('SequenceManager::Count -- ' + _numCount + ' -> ' + value);
		...
		{
			if(_debug) trace('SequenceManager::Total -- ' + _numTotal + ' -> ' + value);
		...
		{
			if(_debug) trace('SequenceManager::Reset');
			_numCount = 0;
		}
	}
}
